...
export const Route = createFileRoute("/make-it")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Make-It: del prototipo a la aplicación real. Programa avanzado de la Cátedra." },
...
const HERO_SLIDES: Slide[] = [
  { title: "", 
    image: "/images/2026/make_bck.jpg",
    hue: 250 },
  { title: "", 
    image: "/images/2026/make_fondo.jpeg",
    hue: 260 },
  { title: "", 
    image: "/images/2026/make_title_back.jpeg", hue: 245 },
  { title: "", 
    image: "/images/2026/make_1.jpeg", hue: 245 },
  { title: "", 
    image: "/images/2026/make_2.jpeg", hue: 245 },
  { title: "", 
    image: "/images/2026/make_3.jpg", hue: 245 },
  ];
...
function MakeItPage() {
  return (
    <InnerPage
      eyebrow=""
      title={<>Make-<span className="text-electric text-glow">It</span></>}
    ...
    >
      ...
      <div>
        ...
        <p className="mt-3 max-w-2xl text-sm text-white/70">
          ...
          experimentan y entregan resultados.
        </p>
      ...
      <div className="mt-14 flex items-center justify-center">
        <a
          href="https://www.fi.upm.es/web/makeit/"
          target="_blank"
          rel="noopener noreferrer"
        >
        <img
