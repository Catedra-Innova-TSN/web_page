...
export const Route = createFileRoute("/try-it")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Programa Try-IT!: primer contacto real con proyectos de datos para estudiantes." },
...
const HERO_SLIDES: Slide[] = [
  { title: "Bienvenida TryIt 2026", 
    image: "/images/2026/tryit_stand.jpg",
    hue: 250 },
  { title: "Keynotes", 
    image: "/images/2026/tryit_keynote1.jpg",
    hue: 260 },
  { title: "Visita de Rectorado UPM a nuestro stand en Try-IT!", 
    image: "/images/2026/tryit_rectorado.jpg", hue: 245 },
  { title: "Mesa redonda con empresas", 
    image: "/images/2026/tryit_mesa.jpg", hue: 245 },
    ...
    talks: [
      {
        ...
        speaker: "Ana María Niño - Comunicadora Estratégica​ y Consultora Desarrollo de Negocio en Innova-tsn",
      ...
      },
      {
        ...
        speaker: "Beatriz Reyes Sánchez - Data Engineer Innova-tsn y Consultora en cuentas de seguros.​",
      ...
      },
      {
        ...
        title: "Del dato a la decisión: un acercamiento práctico para entender cómo se construye un modelo de Machine Learning real​",
...
function TryItPage() {
  ...
  return (
    <InnerPage
      eyebrow=""
      title={<>Try<span className="text-electric text-glow">-IT</span>!</>}
    ...
    >
      ...
      <InfoGrid
        items={[
          { title: "Seminarios", desc: "Workshops donde se trabaja habilidades técnicas y multidisciplinarias." },
          { title: "Scaperoom", desc: "Experiencias de aprendizaje inmersivas basadas en desafíos." },
          { title: "Networking", desc: "Oportunidades de empleo y networking con empresas del sector." },
          { title: "Compromiso", desc: "Participación activa en el programa y colaboración con otros estudiantes cada año." },
        ]}
      />
          ...
          {current.talks.map((t) => (
            ...
            >
              ...
              >
                ...
                {!t.image && (
                  <User size={48} className="relative text-white drop-shadow-[0_0_12px_rgba(23,5,218,0.9)]" />
                )}
              </div>
