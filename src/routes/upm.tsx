...
export const Route = createFileRoute("/upm")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Universidad Politécnica de Madrid, sede académica de la Cátedra.",
      },
        ...
        items={[
          {
            ...
            desc: "Formación de excelencia en disciplinas técnicas con una fuerte orientación práctica e innovadora.",
          },
          {
            title: "Investigación e Innovación",
            desc: "Desarrollo de proyectos científicos y tecnológicos de impacto en colaboración con empresas e instituciones.",
          },
          {
            title: "Transferencia de Conocimiento",
            desc: "Conexión entre universidad, industria y sociedad para transformar la investigación en valor real.",
          },
          {
            title: "ETSI Informáticos",
            desc: "Escuela referente en ciencia e ingeniería del software, datos e IA.",
          },
        ]}
      />
    </InnerPage>
